...
namespace SteamBot
{
    public class Log : IDisposable
    {
        ...
        private readonly IChatBotsLogLineAdder _chatBotsLogLineAdder;
        ...
        public Log(string logFile, string botName = "", LogLevel consoleLogLevel = LogLevel.Info, LogLevel fileLogLevel = LogLevel.Info)
        {
            ...
            ShowBotName = true;
            _chatBotsLogLineAdder = new ChatBotsLogLineAdder(ConfigurationManager.ConnectionStrings["Data"].ConnectionString);
        }
        ...
        protected void _OutputLine(LogLevel level, string line, params object[] formatParams)
        {
            ...
            _chatBotsLogLineAdder.Add(GetLogBotName(), _LogLevel(level).ToUpper(), (formatParams != null && formatParams.Any() ? String.Format(line, formatParams) : line));
